...
using Terraria.ID;
using Terraria.UI;
using static LevelPlus.Core.LevelPlusModPlayer;
...
namespace LevelPlus.UI {
  ...
  class StatButton : UIElement {
    ...
    private void PointSpend(UIMouseEvent evt, UIElement listeningElement) {
      ...
      LevelPlusModPlayer modPlayer = Main.player[Main.myPlayer].GetModPlayer<LevelPlusModPlayer>();
      modPlayer.Spend(type, (ushort)(LevelPlus.SpendFive.Current ? 5 : LevelPlus.SpendTen.Current ? 10 : LevelPlus.SpendTwentyFive.Current ? 25 : 1));
    }
  }
}
